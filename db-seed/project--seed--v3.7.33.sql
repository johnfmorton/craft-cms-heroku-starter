...
CREATE TABLE `announcements` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_eodbnjbbfotypolanfzncealgxtxupjanjsh` (`userId`,`unread`,`dateRead`,`dateCreated`),
  KEY `idx_talgyrgoiihlaajedywgigcjurmuoemljayg` (`dateRead`),
  KEY `fk_gcqmvtsdcrsqwvaylfxzwieyucembessmrvd` (`pluginId`),
  CONSTRAINT `fk_gcqmvtsdcrsqwvaylfxzwieyucembessmrvd` FOREIGN KEY (`pluginId`) REFERENCES `plugins` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_weewirfncwchoqtdnhfkpyucyopmwskjshoo` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
CREATE TABLE `assettransformindex` (
  ...
  KEY `idx_tyrxpqxonbcyhcltxopgaqlooflbbgqgyydg` (`assetId`,`format`,`location`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `drafts` (
  ...
  KEY `idx_qyoivhajzfigpxdcpykrbawaicygpcdpcyjq` (`creatorId`,`provisional`),
...
CREATE TABLE `elements` (
  ...
  KEY `fk_thrjubjyobnpfmaxpqmepvrklcrtwyjpsgso` (`canonicalId`),
  KEY `idx_cqnayyyicfoqbokxzzvzyjkvssznnxeicrfm` (`archived`,`dateDeleted`,`draftId`,`revisionId`,`canonicalId`),
  KEY `idx_azkamndxskazkrhqqazwvqwrpbjyovostixf` (`archived`,`dateDeleted`,`draftId`,`revisionId`,`canonicalId`,`enabled`),
  ...
  CONSTRAINT `fk_thrjubjyobnpfmaxpqmepvrklcrtwyjpsgso` FOREIGN KEY (`canonicalId`) REFERENCES `elements` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `globalsets` (
  ...
  KEY `idx_rrkikuoulelklghsgqlwsrxsuivsvrvylvyy` (`sortOrder`),
...
-- Dump completed on 2022-02-16 15:45:29
-- MariaDB dump 10.19  Distrib 10.5.13-MariaDB, for Linux (aarch64)
--
-- Host: mariadb    Database: project
-- ------------------------------------------------------
...
set autocommit=0;
INSERT INTO `announcements` VALUES (1,1,NULL,'Editor Slideouts','Double-click entries and other editable elements to try the new editor slideout interface.',1,NULL,'2022-02-15 14:52:10'),(2,1,NULL,'Streamlined Entry Publishing Flow','The entry publishing workflow is now [simpler and more intuitive](https://craftcms.com/knowledge-base/editing-entries).',1,NULL,'2022-02-15 14:52:10');
...
set autocommit=0;
INSERT INTO `changedattributes` VALUES (1,1,'email','2022-02-15 14:54:58',0,1),(1,1,'firstName','2022-02-15 14:54:58',0,1),(1,1,'lastName','2022-02-15 14:54:58',0,1),(1,1,'lastPasswordChangeDate','2022-02-15 14:54:58',0,1),(1,1,'password','2022-02-15 14:54:58',0,1),(1,1,'username','2022-02-15 14:54:58',0,1),(3,1,'lastPasswordChangeDate','2022-02-16 15:43:14',0,3),(3,1,'password','2022-02-16 15:43:14',0,3),(3,1,'verificationCode','2022-02-16 15:43:14',0,3),(3,1,'verificationCodeIssuedDate','2022-02-16 15:43:14',0,3);
...
set autocommit=0;
INSERT INTO `content` VALUES (1,1,1,NULL,'2020-03-27 13:22:43','2022-02-15 14:54:58','b77b0362-fbf0-45dd-a5d7-e1b0c971eb48',NULL,NULL),(2,2,1,'Homepage','2020-03-27 13:38:49','2020-10-16 15:16:16','7fa40164-962a-4e1b-804a-245447006340',NULL,NULL),(3,3,1,NULL,'2022-02-16 15:41:25','2022-02-16 15:43:14','990c8072-c3a6-4ea4-8bc9-8e4962dadbeb',NULL,NULL);
...
set autocommit=0;
INSERT INTO `elements` VALUES (1,NULL,NULL,NULL,NULL,'craft\\elements\\User',1,0,'2020-03-27 13:22:43','2022-02-15 14:54:58',NULL,NULL,'9c39b369-6229-4753-83e1-afd4da7acf29'),(2,NULL,NULL,NULL,NULL,'craft\\elements\\Entry',1,0,'2020-03-27 13:38:49','2020-10-16 15:16:16',NULL,NULL,'7526d70b-8b45-4af6-b5b8-c56c6a44e34c'),(3,NULL,NULL,NULL,NULL,'craft\\elements\\User',1,0,'2022-02-16 15:41:25','2022-02-16 15:43:14',NULL,NULL,'f38a7ed0-9c8f-46ae-bc03-33ae98a2382e');
...
set autocommit=0;
INSERT INTO `fields` VALUES (1,2,'Error Image','errorImage','global',NULL,'',1,'site',NULL,'craft\\fields\\Assets','{\"useSingleFolder\":\"\",\"defaultUploadLocationSource\":\"volume:5c642d7e-b16b-4836-9575-668d75d242e5\",\"defaultUploadLocationSubpath\":\"\",\"singleUploadLocationSource\":\"volume:5c642d7e-b16b-4836-9575-668d75d242e5\",\"singleUploadLocationSubpath\":\"\",\"restrictFiles\":\"1\",\"allowedKinds\":[\"image\"],\"sources\":[\"volume:5c642d7e-b16b-4836-9575-668d75d242e5\"],\"source\":null,\"targetSiteId\":null,\"viewMode\":\"large\",\"limit\":\"1\",\"selectionLabel\":\"\",\"localizeRelations\":false,\"validateRelatedElements\":\"\"}','2020-03-27 13:30:08','2020-03-27 13:30:08','a5cb77be-c4d9-4d3e-88fb-d5384ca13941'),(2,2,'Error Headline','errorHeadline','global',NULL,'',1,'none',NULL,'craft\\fields\\PlainText','{\"placeholder\":\"\",\"code\":\"\",\"multiline\":\"\",\"initialRows\":\"4\",\"charLimit\":\"\",\"columnType\":\"text\"}','2020-03-27 13:30:08','2020-03-27 13:30:08','b8ba7115-3804-4c06-8a96-501963d1fc5c'),(3,2,'Error Text','errorText','global',NULL,'',1,'none',NULL,'craft\\fields\\PlainText','{\"placeholder\":\"\",\"code\":\"\",\"multiline\":\"1\",\"initialRows\":\"4\",\"charLimit\":\"\",\"columnType\":\"text\"}','2020-03-27 13:30:08','2020-03-27 13:30:08','e6d658aa-c335-4f15-bbcd-59fe05d9e913');
...
set autocommit=0;
INSERT INTO `gqlschemas` VALUES (1,'Public Schema','[]',1,'2022-02-15 14:56:55','2022-02-15 14:56:55','f9b27431-f7f8-495e-8e98-1179bbbfab2b');
...
set autocommit=0;
INSERT INTO `gqltokens` VALUES (1,'Public Token','__PUBLIC__',0,NULL,NULL,1,'2020-10-16 15:16:16','2022-02-15 14:56:55','1b9fd892-85aa-46c0-9bed-c7c82bf46416');
...
set autocommit=0;
INSERT INTO `info` VALUES (1,'3.7.33','3.7.33',0,'vqpruzxthcqn','2@jdrxafloer','2020-03-27 13:22:43','2022-02-15 20:42:51','85f4c669-6b2b-4771-976e-a4bcdd2bd77b');
...
set autocommit=0;
INSERT INTO `plugins` VALUES (13,'vite','1.0.23','1.0.0','unknown',NULL,'2021-05-16 01:10:49','2021-05-16 01:10:49','2022-02-16 15:40:03','b2b86d72-0b98-4e94-a77d-681262e561b0'),(14,'minify','1.2.10','1.0.0','unknown',NULL,'2022-02-15 20:42:51','2022-02-15 20:42:51','2022-02-16 15:40:03','48897c95-fb15-4e2d-8adb-8a0450a583cc');
...
set autocommit=0;
INSERT INTO `searchindex` VALUES (1,'lastname',0,1,' morton '),(1,'firstname',0,1,' john '),(1,'username',0,1,' morton jmx2 com '),(2,'title',0,1,' homepage '),(2,'slug',0,1,' homepage '),(1,'fullname',0,1,' john morton '),(1,'email',0,1,' morton jmx2 com '),(1,'slug',0,1,''),(3,'email',0,1,' morton heroku admin jmx2 com '),(3,'fullname',0,1,''),(3,'lastname',0,1,''),(3,'firstname',0,1,''),(3,'username',0,1,' morton heroku admin jmx2 com '),(3,'slug',0,1,'');
...
set autocommit=0;
INSERT INTO `sections` VALUES (4,NULL,'Errors','errors','channel',0,'all','end',NULL,'2020-03-27 13:38:49','2020-03-27 13:38:49',NULL,'a72bfe0c-3389-4f9f-8ec1-ab318ec10b29'),(5,NULL,'Homepage','homepage','single',0,'all','end',NULL,'2020-03-27 13:38:49','2020-03-27 13:38:49',NULL,'54e60257-f31a-44aa-960e-bbd364197e28');
...
set autocommit=0;
INSERT INTO `users` VALUES (1,'morton@jmx2.com',NULL,'John','Morton','morton@jmx2.com','$2y$13$3DTTWVYTh8H9DaSz0M2NMOTOFK0d2x/LH0xI9nsY02Kv8/ap3jmNq',1,0,0,0,'2022-02-16 15:40:01',NULL,'2022-02-16 15:42:41',1,'2022-02-16 15:42:41',NULL,1,NULL,NULL,NULL,0,'2022-02-15 14:54:58','2020-03-27 13:22:44','2022-02-16 15:42:41','6aaac777-3f7f-4a59-9f21-06bcb8de9a13'),(3,'morton+heroku-admin@jmx2.com',NULL,'','','morton+heroku-admin@jmx2.com','$2y$13$x0Djc0doXkCiEHohWXVIUOPAB2KLiwm5xYNxC.V9orGc1tT868EWS',1,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,0,'2022-02-16 15:43:14','2022-02-16 15:41:25','2022-02-16 15:43:14','7d099579-9d5f-46cb-8849-1462ca05ec85');
